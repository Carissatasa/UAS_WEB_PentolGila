  ...
  <div class="content">
    <div class="container">
      <div class="row">
        ...
        <h2 class="judul mt-5 mb-3">Grafik Total Penjualan Produk Pentol Gila</h2>
...
?>
        ...
        <h2 class="judul mt-5 mb-3">Grafik Pembeli dengan Total Pembelian Terbanyak</h2>
...
$query = mysqli_query($koneksi,"select nama_pelanggan as pembeli, sum(total) as amount
from pesanan pe
join pembeli p on p.username = pe.nama_pelanggan
              ...
              var barConfig = {
                ...
                data: {
                  datasets: [{
                    ...
                    label: 'Grafik Pembeli dengan Total Pembelian Terbanyak'
                  }],
                  labels: <?php echo json_encode($pembeli); ?>
                },
                options: {
                  responsive: true
                }
